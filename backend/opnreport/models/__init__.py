...
from opnreport.render import get_json_default
...
from opnreport.models.db import all_metadata_defined as __all  # noqa
...
def includeme(config):
    ...
    config.add_request_method(
        ...
        lambda request: get_tm_dbsession(dbsession_factory, request.tm),
        'dbsession',
        reify=True
    )
