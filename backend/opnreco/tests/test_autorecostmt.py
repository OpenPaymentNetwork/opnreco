...
class TestSortableMatch(unittest.TestCase):
    ...
    def test_with_partial_description_match(self):
        ...
        self.assertEqual(
            (obj.score, datetime.date(2019, 1, 15), 33, (55,)), obj.sort_key
        )
...
class Test_auto_reco_statement(unittest.TestCase):
    ...
    def add_transfer_6502(
        ...
        fm = db.FileMovement(
            ...
            transfer_record_id=m.transfer_record_id,
            ts=m.ts,
            wallet_delta=0,
    ...
    def assert_recos(
        self, expect_recos=None, expect_movements=0, expect_account_entries=0
    ):
        ...
        for reco in recos:
            m_total = sum(
                (fm.vault_delta + fm.wallet_delta for fm in movements[reco.id]), 0
            )
    ...
    def test_full_match(self):
        ...
        self.assert_recos(expect_recos=2, expect_movements=2, expect_account_entries=2)
    ...
    def test_one_match(self):
        ...
        self.assert_recos(expect_recos=1, expect_movements=1, expect_account_entries=2)
    ...
    def test_no_match(self):
        ...
        self.assert_recos(expect_recos=0, expect_movements=0, expect_account_entries=2)
    ...
    def test_value_mismatch(self):
        ...
        self.assert_recos(expect_recos=1, expect_movements=2, expect_account_entries=2)
    ...
    def test_dont_match_entry_before_movement(self):
        ...
        self.assert_recos(expect_recos=0, expect_movements=1, expect_account_entries=2)
    ...
    def test_no_match_without_bundle(self):
        ...
        self.assert_recos(expect_recos=0, expect_movements=2, expect_account_entries=2)
    ...
    def test_match_bundle_and_single_at_once(self):
        ...
        self.assert_recos(expect_recos=2, expect_movements=3, expect_account_entries=2)
    ...
    def test_match_two_bundles_at_once(self):
        ...
        self.assert_recos(expect_recos=2, expect_movements=4, expect_account_entries=2)
